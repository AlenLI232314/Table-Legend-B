...
public class CoinButton : MonoBehaviour
{
    ...
    // Determines what value to add/remove from player's coins when the button is pressed. Assigned in the Editor
    public int coinsToGiveOrTake;
    ...
    void Clicked()
    {
        gameManager.giveOrTakeCoins(coinsToGiveOrTake);
    }
}
